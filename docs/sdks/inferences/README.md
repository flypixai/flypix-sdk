...
with FlyPix(
    ...
    res = fly_pix.inferences.list_for_tenant(tenant_id=UUID("123e4567-e89b-12d3-a456-426614174000"))
...
with FlyPix(
    ...
    res = fly_pix.inferences.list_for_project(project_id=UUID("123e4567-e89b-12d3-a456-426614174000"))
...
with FlyPix(
    ...
    res = fly_pix.inferences.list_for_file(file_id=UUID("123e4567-e89b-12d3-a456-426614174000"))
