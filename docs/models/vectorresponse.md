...
| `vector_id`                                          | *str*                                                | :heavy_check_mark:                                   | A string in UUID format                              | 123e4567-e89b-12d3-a456-426614174000                 |
| `metadata`                                           | [models.VectorMetadata](../models/vectormetadata.md) | :heavy_check_mark:                                   | N/A                                                  |                                                      |
