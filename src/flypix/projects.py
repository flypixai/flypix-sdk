...
class Projects(BaseSDK):
    ...
    def list_for_tenant(
        ...
        *,
    ...
    ) -> List[models.ProjectResponse]:
        r"""Get Projects For Tenant
        ...
        request = models.ProjectsListForTenantRequest(
            tenant_id=tenant_id,
        )

        req = self._build_request(
            method="GET",
            path="/projects/for-tenant/{tenant_id}",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="projects_list_for_tenant",
                oauth2_scopes=None,
    ...
    def delete(
        ...
        *,
        ...
        request = models.ProjectsDeleteRequest(
    ...
    def create(
        ...
        *,
        ...
        request = models.ProjectCreationRequest(
            tenant_id=tenant_id,
            name=name,
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.ProjectCreationRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
